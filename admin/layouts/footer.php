...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; 2022 | Sistem Informasi Itenas Bandung | This website is made with <i class="fas fa-heart" aria-hidden="true" style="color: red;"></i> by <a href="https://www.linkedin.com/in/wafie-abiyya-2b74a7268/" target="_blank">Wafie Abiyya</a></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
